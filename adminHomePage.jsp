<%-- 
    ...
    Created on : May 4, 2020, 12:20:31 AM
    Author     : abc
--%>
...
<body class="homepage" style="background-color: #5d8080">
  ...
  cursor: pointer;">
    <form action="/action_page.php">
      ...
      <button style="float:right; padding: 6px 15px;color: #ddd;background-color: #B31C1C;border:1px solid #B31C1C;" type="submit">
      	<a class="fa fa-search" href="SearchMovieByName.html"></a></button>
    </form>
  </div>
...
<div style="position: relative;text-align: center;color: white;">
    <img src="content/i6.jpg" class="img-responsive centerd" style="max-width:100%;max-height:100%; border-radius: 6px;" alt="image">
    <div style="position: absolute;top: 50%; left: 50%;transform: translate(-50%, -50%);">
    <button style="background-color: black;border-color:#19235e ;padding: 20px;margin:20px;margin-right: 50px;  "><a href="Cinemas(View).html" style="color: white;">Enter View Mode</a></button>
    <button style="margin:20px;background-color: black;border-color:#19235e ;padding: 20px;"><a href="UpdateSchedule.jsp" style="color: white;">Update Schedule</a></button><br>
    <button style="margin:20px;background-color: black;border-color:#19235e ;padding: 20px;"><a href="AddMovie.html" style="color: white;">Add Movie</a></button>
    <button style="margin:20px;background-color: black;border-color:#19235e ;padding: 20px;"><a href="DeleteMovie.html" style="color: white;">
    Delete Movie</a></button>
</div>
	</div>
	
    <br>  <br>
	
	<div style="border:6px double #660C23;height: 200px;"><h2 style="margin-left: 550px;font-size: 30px;">Top Rated Movies</h2>
  ...
  <!--  <section id="services" class="service-item">
        <div class="container">
            <div class="center wow fadeInDown  animated animated animated" data-wow-duration="200ms" data-wow-delay="200ms" style="visibility: visible; animation-duration: 200ms; animation-delay: 200ms;">
               <div class="col-md-6 col-md-offset-4"><h2 style="color:white">Need some help?</h2><br>
                <div class="telephone"> <a href="tel:131546" style="color:#fff">1300 807 510</a></div></div> 
            </div>
        </div>-->
        <!--/.container-->
    </section>
