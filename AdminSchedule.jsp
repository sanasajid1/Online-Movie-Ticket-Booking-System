<%-- 
    ...
    Created on : May 13, 2020, 4:49:31 AM
    Author     : mahas
--%>
...
<body class="homepage" style="">
    ...
    <div class="topbar">
        <div class="container-fluid text-center">
            <div class="row">
                <div class="col-sm-3">
                    <div class="wow fadeInDown animated animated animated" data-wow-duration="1000ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeInDown;"> <img src="./Movie Ticket Booking._files/logo1.png" alt="Logo" class="logo1 img-responsive"> </div>
                </div>
                ...
                <div class="dropdown-content" style="left:0;">
                    <table>
                        ...
                        <tr>
                            <th>A Quiet Place</th>
                            <th>12p.m</th>
                            <th><a href="updateMovieSchedule.html" style="color: black; background-color: none;">Update</a></th>
                            <th><input style="color: black;" type="button" onclick='alert("Schedule Deleted!!!")' value="Delete"></th>
                        </tr>
                        <tr>
                            <th>Bird Box</th>
                            <th>3p.m</th>
