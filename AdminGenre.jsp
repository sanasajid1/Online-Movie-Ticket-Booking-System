...
<html lang="en" class="csstransforms csstransforms3d csstransitions"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="content/Genre/css/bootstrap.css" rel="stylesheet">
    <link href="content/Genre/css/font-awesome.min.css" rel="stylesheet">
    <link href="content/Genre/css/animate.min.css" rel="stylesheet">
    <link href="content/Genre/css/prettyPhoto.css" rel="stylesheet">
    <link href="content/Genre/css/main.css" rel="stylesheet">
    <link href="content/Genre/css/responsive.css" rel="stylesheet">
    <script src="content/Genre/jquery.js.download"></script>
    <link rel="stylesheet" type="text/css" href="content/Genre/css/jquery.dataTables.css">
    <link rel="stylesheet" type="text/css" href="content/Genre/css/dataTables.bootstrap.css">
    <link rel="stylesheet" type="text/css" href="content/Genre/css/dataTables.responsive.css">
    <!--[if lt IE 9]>
    <script src="js/html5shiv.js"></script>
    <script src="js/respond.min.js"></script>
    <![endif]-->
    <link href="content/Genre/css" rel="stylesheet" type="text/css">
    -
    <!--  Quantcast Tag -->
...
<body class="homepage" style="">
    ...
    <div class="topbar">
        <div class="container-fluid text-center">
            <div class="row">
                <div class="col-sm-3">
                    <div class="wow fadeInDown animated animated animated" data-wow-duration="1000ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeInDown;"> <img src="content/Genre/logo1.png" alt="Logo" class="logo1 img-responsive"> </div>
                </div>
  ...
  cursor: pointer;">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item"> <img src="content/Genre/a1.jpg" alt="images">
            ...
            <div class="item"> <img src="content/Genre/a2.jpg" alt="images">
                <div class="carousel-caption">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="carousel-content center centered">
            ...
            <div class="item active"> <img src="content/Genre/a5.jpg" alt="images">
                <div class="carousel-caption">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="carousel-content center centered">
            ...
            <div class="item"> <img src="content/Genre/a6.jpg" alt="images">
                <div class="carousel-caption">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="carousel-content center centered">
            ...
            <div class="row" style="text-align:center">
                ...
                <div class="col-md-6 col-sm-4  wow fadeInDown animated animated animated" data-wow-duration="200ms" data-wow-delay="200ms" style="visibility: visible; animation-duration: 200ms; animation-delay: 200ms;">
                    <!--<div class="feature-wrap">
                        ...
                        <br> <button style="background-color: black; border: none;" formaction="schedule.jsp"><a  href="schedule.jsp"><img src="content/c3.jpg" class="img-responsive img-thumbnail centerd" style="max-width:330px;min-width:330px;max-height:180px;min-height:180px" alt="image"></a> 
                        </button></div>
                    <h2>Comedy</h2>-->
                    <div class="feature-wrap">
 ...
 <section id="footer-bg">
		...
		<div class="part2">
		 <img src="content/Genre/ulogo1.jpg" class="img-responsive centerd" style="max-width:330px;min-width:330px;max-height:180px;min-height:180px" alt="image">		        
           	<!-- Title -->
				
                <ul class="quick-links">
				
									<li>Location: Emporium Mall by Nishat Group.</li>
                    <br />
									<li>Address: Abdul Haque Rd, adjacent to Lahore International Expo Centre، Trade Centre Commercial Area Phase 2 Johar Town, Lahore, Punjab 54000</li>
                    <br />
									<li>Phone: 0333 333333</li>
                    <br />
								</ul>
                        ...
                        <div id="bunch_footer_image-2" class="col-lg-3 col-md-4 col-sm-6 col-xs-6">		
			...
			<div class="container">
				<div class="">
					...
					<div class="copyright col-sm-6">
												                            <ul class="social ">
                                                                    <li><a href="content/Genre/my.html#" class="hvr-radial-out"><i class="fa fa-facebook"></i></a></li>
                                                                    <li><a href="content/Genre/my.html#" class="hvr-radial-out"><i class="fa fa-twitter"></i></a></li>
                                                                    <li><a href="content/Genre/my.html#" class="hvr-radial-out"><i class="fa fa-google-plus"></i></a></li>
                                                                    <li><a href="content/Genre/my.html#" class="hvr-radial-out"><i class="fa fa-linkedin"></i></a></li>
                                                            </ul>
